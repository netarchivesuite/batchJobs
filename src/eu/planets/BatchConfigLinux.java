/* File:        $Id: BatchConfigLinux.java,v 1.2 2009/06/03 11:46:54 jolf Exp $
...
/**
 * The linux instance of BatchConfig.
 */
public class BatchConfigLinux extends BatchConfig {

    /**
     * The Constructor.
     * Only calls the constructor of the inherited class.
     */
    public BatchConfigLinux() {
        super();
    }
    
    /**
     * Method to create the installation script.
     * 
     * @param outputDir The directory to put the install script.
     */
    @Override
    protected void createInstallScript(File outputDir) {
        try {
            File installScript = new File(outputDir, Constants
                    .FILE_NAME_INSTALL_LINUX);
    ...
    /**
     * Method to create a start-all script.
     * 
     * @param outputDir The directory where the start-all script is to 
     * be placed.
     */
    @Override
    protected void createStartAllScript(File outputDir) {
        ...
        try {
            ...
            File localScript = new File(outputDir, 
                    Constants.FILE_NAME_START_ALL_LINUX);
    ...
    /**
     * Method to create the start script for running a batch job locally.
     * 
